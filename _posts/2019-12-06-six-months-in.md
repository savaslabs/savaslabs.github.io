...
I can’t stress the importance of documentation enough: in onboarding, for coding standards and workflow. Part of my struggle at the beginning was due to READMEs that lacked information I needed on module versions, Pantheon tokens, and other things specific to client projects that would be difficult to Google.

Plus, seasoned developers tend to forget the need to explain tidbits that have become second nature to them. Take it upon yourself to add to documentation (READMEs, [secret gists](https://gist.github.com/), etc.) that would aid future developers in the onboarding process, and current developers on present or future assignments.

I created a secret gist with instructions for updating our current site with marketing content. I have contributed to company-wide discussions about our company’s tech spec process, the design to development handoff, and front-end build-out, among other processes.
...
This took a not-so-insignificant amount of time and seriously slowed down Webpack, all in the name of cleaner template files and, though I may not have known it at the time, separation of concerns. We’ll be incorporating the later phases Adam describes in upcoming projects.
